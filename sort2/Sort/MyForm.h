...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent (void)
		{
			...
			this->algorithmBox->Items->AddRange (gcnew cli::array< System::Object^  > (9)
			{
				L"Bubble sort", L"Selection sort", L"Insertion sort",
					L"Merge sort", L"Merge sort (recursive)", L"Quick sort", L"Quick sort (recursive)", L"Radix sort", L"Heap sort"
			});
			...
			// chart
			// 
			chartArea3->AxisX->Title = L"Count of Data";
			chartArea3->AxisY->Title = L"Time";
			...
			title3->Font = (gcnew System::Drawing::Font (L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
														 static_cast<System::Byte>(0)));
			title3->Name = L"Title1";
			title3->Text = L"Effectiveness Chart";
