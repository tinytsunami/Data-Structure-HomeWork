...
namespace MagicSquare {
	...
	private: System::Windows::Forms::DataGridView^  gridViewShow;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->gridViewShow = (gcnew System::Windows::Forms::DataGridView ());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->gridViewShow))->BeginInit ();
			this->SuspendLayout ();
			// 
			// groupBox1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font (L"·s²Ó©úÅé", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
			...
			// gridView
			// 
			this->gridView->Controls->Add (this->gridViewShow);
			...
			// gridViewShow
			// 
			this->gridViewShow->ColumnHeadersHeightSizeMode = System::Windows::Forms::DataGridViewColumnHeadersHeightSizeMode::AutoSize;
			this->gridViewShow->Dock = System::Windows::Forms::DockStyle::Fill;
			this->gridViewShow->Location = System::Drawing::Point (0, 0);
			this->gridViewShow->Name = L"gridViewShow";
			this->gridViewShow->RowTemplate->Height = 24;
			this->gridViewShow->Size = System::Drawing::Size (629, 447);
			this->gridViewShow->TabIndex = 0;
			// 
			// MyForm
			// 
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->gridViewShow))->EndInit ();
